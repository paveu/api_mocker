...
class TestBasic(TestCase):
    ...
    def test_job_post_view2(self, mock_post):
        ...
        # ('mock.call_args_list', [call(u'http://jsonplaceholder.typicode.com',
        # data=None, headers={'Content-type': 'application/json'}),
        #    call(u'https://flask-app-pawelste.c9users.io/callback/',
        # data='"good"', headers={'Content-type': u'application/json'})])

        # mocked api call
        self.assertIn(
            mock.call(u'http://jsonplaceholder.typicode.com',
                      data=None,
        ...
        # callback call
        self.assertIn(
            mock.call(u'https://flask-app-pawelste.c9users.io/callback/',
                      data='"good_text"',
