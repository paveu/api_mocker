# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-12-24 20:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allowed_http_method', models.CharField(choices=[('POST', 'POST'), ('GET', 'GET'), ('PATCH', 'PATCH'), ('PUT', 'PUT')], max_length=256, verbose_name='Allowed HTTP method for a mocked API')),
                ('allowed_destination_content_type', models.CharField(choices=[('application/json', 'application/json')], max_length=256, verbose_name='Allowed content type for a mocked API')),
